-- Aplicar uma única vez após 0019. Inclui o proprietário na identidade única do ativo.
-- Permite que Ale e Ana possuam o mesmo ativo sem que uma importação sobrescreva a outra.
